...
@section('titulo','Agregar Profesor')
@section('direccion', 'Agregar nueva profesor')

@section('contenido')

<div class="card card-purple col-12 ">
<div class="card-header">
	<h3 class="card-title">Agregar profesor nuevo</h3>
</div>
...
<form action="{{ Route('admin.nuevoProfesor') }}" method="POST">
	{{ csrf_field() }}
		<div class="card-body">

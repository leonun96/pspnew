...
@endforeach
<form action="{{ route('profesor.editarPerfil') }}" method="POST">
	{{ csrf_field() }}
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="apellidos"
				 placeholder="Ingrese apellidos del alumno" value="{{ $profe->apellidos }}">
			</div>
			<div class="form-group">
				<label for="fnac">Fecha nacimiento</label>
				<input type="date" class="form-control {{ $errors->has('fnac') ? 'is-invalid' : ''}}"
				 name="fnac"  value="{{ $profe->fnac }}">
			</div>
			<div class="form-group">
				<label for="telenfono">Telefono</label>
				<input type="text" class="form-control" name="telefono"
				value="{{ $profe->telefono }}" placeholder="Ingrese telefono del alumno" >
			</div>
			<div class="form-group">
